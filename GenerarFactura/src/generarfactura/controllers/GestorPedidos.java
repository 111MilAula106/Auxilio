...
public class GestorPedidos {
    ...
    private void rellenarListas() {
        ...
        pedido1.getDetallePedido().add(new Pizza("Hawaiana", "Horno", "Dulce", 12, 10.5));
        pedido1.getDetallePedido().add(new Pizza("Eleazar", "Parrilla", "Especial", 12, 35.5));
        ...
        pedido5.getDetallePedido().add(new Pizza("Muzzarella", "Horno", "Muzzarella", 2));
        pedido5.getDetallePedido().add(new Pizza("Muzzarella", "Parilla", "Muzzarella", 4));
