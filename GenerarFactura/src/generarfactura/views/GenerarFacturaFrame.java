...
import generarfactura.views.UIfactura;
...
public class GenerarFacturaFrame extends javax.swing.JFrame {
    ...
    public GenerarFacturaFrame() {
        ...
        btnnuevopedido.addActionListener((ActionEvent ae) -> {
            nuevoPedido();
        });
...
private void confirmarFactura() {
        UIfacturaGenerada nuevaFacturaGen= new UIfacturaGenerada();
        nuevaFacturaGen.setVisible(true);
    }
private void cancelarFactura() {
        JOptionPane.showMessageDialog(this, "La opción seleccionada se encuentra en desarrollo.");;
    }
private void nuevoPedido() {
        UIpedidos nuevoPedido= new UIpedidos();
    ...
    private void rellenarTablaPedidos() {
        ...
        if (pedidoSeleccionado != null) {
            ...
            for (int i = 0; i < pedidoSeleccionado.getDetallePedido().size(); i++) {
                ...
                precioTotal= precioTotal+ pedidoSeleccionado.getDetallePedido().get(i).getPrecioUnitario();
            }
        ...
        tfmontototal.setText("$ " + Double.toString(precioTotal));
    }
